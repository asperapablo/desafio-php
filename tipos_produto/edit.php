...
if(!empty($_POST)){
    $res = $tipoProduto->update($_GET['id'], $_POST['nome'], $_REQUEST['percentual_imposto']);
}

$objTipoProduto = $tipoProduto->get($_GET['id']);
?>
    ...
    <div class="nav-wrapper">
        <div class="container">
            <div class="col s12">
                ...
                <a href="/tipos_produto/index.php" class="breadcrumb">Produtos</a>
        ...
        <form method="post" class="col s12">
            <div class="row">
                <div class="input-field col s6">
                    <input type="text" class="validate" id="nome" name="nome" value="<?=$objTipoProduto['nome']?>" required>
                    <label for="nome">Nome do produto</label>
                </div>
                <div class="input-field col s6">
                    <input type="number" max="100" class="validate" id="percentual_imposto"
                           name="percentual_imposto" value="<?=$objTipoProduto['percentual_imposto']?>" required>
